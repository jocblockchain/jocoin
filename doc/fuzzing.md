...
```sh
$ git clone https://github.com/jocblockchain/jocoin
$ cd jocoin/
$ ./autogen.sh
...
[`process_message`](https://github.com/jocblockchain/jocoin/blob/master/src/test/fuzz/process_message.cpp) is a fuzzing harness for the [`ProcessMessage(...)` function (`net_processing`)](https://github.com/jocblockchain/jocoin/blob/master/src/net_processing.cpp). The available fuzzing harnesses are found in [`src/test/fuzz/`](https://github.com/jocblockchain/jocoin/tree/master/src/test/fuzz).
...
with certain assembly code from Jocoin Core's code. See [developer notes on sanitizers](https://github.com/jocblockchain/jocoin/blob/master/doc/developer-notes.md#sanitizers)
