...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 jotes per kB (0.00001 JOCO). This is to prepare for dropping the minimum transaction fee to 0.1 jotes per kB (0.0001 JOCO) in the next release.
