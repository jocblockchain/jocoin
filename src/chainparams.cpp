...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("dnsseed1.jocoin.io");
        vSeeds.emplace_back("dnsseed2.jocoin.io");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet1-seed.jocoin.io");
        vSeeds.emplace_back("testnet2-seed.jocoin.io");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1715593041, 0, 0x207fffff, 0, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
